...
# Create logger
logger = logging.getLogger('data_cleaning')  # Use getLogger (case-sensitive)
...
logger.addHandler(console_handler)  # Use addHandler (not Handler)
...
if __name__ == "__main__":
    ...
    cleaned_data_filename = "swiggy_clean.csv"
    # data save path
